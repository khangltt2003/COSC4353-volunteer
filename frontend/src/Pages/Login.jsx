    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 h-screen w-full">
      ...
      <div className="bg-gray-200 flex flex-col justify-center">
        <form className="max-w-[400px] w-full mx-auto rounded-lg bg-white p-4" onSubmit={handleSubmit}>
          ...
          <button className="border w-full my-5 py-2 bg-blue-400 hover:bg-blue-300 text-white" type="submit">
            Sign In
          </button>
          ...
          <div className="flex justify-between">
            ...
            <button className="text-black hover:text-gray-400" onClick={() => alert("Redirecting to create an account page...")}>
              Create an Account
            </button>
          </div>
        </form>
