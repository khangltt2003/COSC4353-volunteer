...
const EventForm = () => {
  ...
  return (
    <div className="full-w w-screen min-h-screen font-black bg-[url('/manager.png')] space-y-16 bg-cover bg-center ">
          ...
          <div className="space-y-3 w-full">
            ...
            <input
              ...
              className={`pl-3 text-left rounded-md border-2 w-full h-12 font-light placeholder-slate-400 ${
                eventNameError ? "border-red-500" : "border-gray-600"
              }`}
            />
            ...
            <textarea
              ...
              className={`pl-3 pt-2 text-left rounded-md border-2 w-full h-12 font-light placeholder-slate-400 ${
            ...
            <textarea
              ...
              className={`pl-3 pt-2 text-left rounded-md border-2 w-full h-12 font-light placeholder-slate-400 ${
                areaError ? "border-red-500" : "border-gray-600"
              }`}
            />
