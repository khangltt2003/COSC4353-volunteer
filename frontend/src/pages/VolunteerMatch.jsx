    ...
    return (
        <div className="relative min-h-screen font-black space-y-16 bg-cover bg-center bg-[url('/Match.png')]">
            <div className="absolute left-0 bottom-0 p-4">
                <img src="/match.png" alt="Match Image" className="max-w-xl h-auto" />
            </div>
            <div className="absolute -top-32 left-48 p-4">
                <img src="/logo.png" alt="Logo Image" className="max-w-xs w-44 h-auto" />
            </div>
